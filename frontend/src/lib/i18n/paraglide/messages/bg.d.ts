...
export const admin_dashboard_card_accountability_description: (inputs: Admin_Dashboard_Card_Accountability_DescriptionInputs) => LocalizedString;
export const admin_dashboard_card_accountability_title: (inputs: Admin_Dashboard_Card_Accountability_TitleInputs) => LocalizedString;
export const admin_dashboard_card_api_description: (inputs: Admin_Dashboard_Card_Api_DescriptionInputs) => LocalizedString;
export const admin_dashboard_card_api_title: (inputs: Admin_Dashboard_Card_Api_TitleInputs) => LocalizedString;
export const admin_dashboard_card_content_description: (inputs: Admin_Dashboard_Card_Content_DescriptionInputs) => LocalizedString;
export const admin_dashboard_card_content_title: (inputs: Admin_Dashboard_Card_Content_TitleInputs) => LocalizedString;
export const admin_dashboard_card_publishing_description: (inputs: Admin_Dashboard_Card_Publishing_DescriptionInputs) => LocalizedString;
export const admin_dashboard_card_publishing_title: (inputs: Admin_Dashboard_Card_Publishing_TitleInputs) => LocalizedString;
export const admin_dashboard_subtitle: (inputs: Admin_Dashboard_SubtitleInputs) => LocalizedString;
export const admin_dashboard_title: (inputs: Admin_Dashboard_TitleInputs) => LocalizedString;
export const admin_language_bg: (inputs: Admin_Language_BgInputs) => LocalizedString;
export const admin_language_en: (inputs: Admin_Language_EnInputs) => LocalizedString;
export const admin_login_email: (inputs: Admin_Login_EmailInputs) => LocalizedString;
export const admin_login_failed_title: (inputs: Admin_Login_Failed_TitleInputs) => LocalizedString;
export const admin_login_invalid_email: (inputs: Admin_Login_Invalid_EmailInputs) => LocalizedString;
export const admin_login_missing_password: (inputs: Admin_Login_Missing_PasswordInputs) => LocalizedString;
export const admin_login_password: (inputs: Admin_Login_PasswordInputs) => LocalizedString;
export const admin_login_submit: (inputs: Admin_Login_SubmitInputs) => LocalizedString;
export const admin_login_subtitle: (inputs: Admin_Login_SubtitleInputs) => LocalizedString;
export const admin_login_title: (inputs: Admin_Login_TitleInputs) => LocalizedString;
...
export const admin_not_found_public_site: (inputs: Admin_Not_Found_Public_SiteInputs) => LocalizedString;
export const admin_not_found_title: (inputs: Admin_Not_Found_TitleInputs) => LocalizedString;
export const admin_shell_close_navigation: (inputs: Admin_Shell_Close_NavigationInputs) => LocalizedString;
export const admin_shell_language_label: (inputs: Admin_Shell_Language_LabelInputs) => LocalizedString;
export const admin_shell_navigation_label: (inputs: Admin_Shell_Navigation_LabelInputs) => LocalizedString;
export const admin_shell_open_navigation: (inputs: Admin_Shell_Open_NavigationInputs) => LocalizedString;
export const admin_shell_sign_out: (inputs: Admin_Shell_Sign_OutInputs) => LocalizedString;
export const admin_shell_subtitle: (inputs: Admin_Shell_SubtitleInputs) => LocalizedString;
export const admin_shell_title: (inputs: Admin_Shell_TitleInputs) => LocalizedString;
export const admin_shell_view_public_site: (inputs: Admin_Shell_View_Public_SiteInputs) => LocalizedString;
export const public_nav_access_title: (inputs: Public_Nav_Access_TitleInputs) => LocalizedString;
export const public_nav_action_contact_hall: (inputs: Public_Nav_Action_Contact_HallInputs) => LocalizedString;
export const public_nav_action_report_concern: (inputs: Public_Nav_Action_Report_ConcernInputs) => LocalizedString;
export const public_nav_action_view_notices: (inputs: Public_Nav_Action_View_NoticesInputs) => LocalizedString;
export const public_nav_alerts_description: (inputs: Public_Nav_Alerts_DescriptionInputs) => LocalizedString;
export const public_nav_alerts_label: (inputs: Public_Nav_Alerts_LabelInputs) => LocalizedString;
export const public_nav_business_label: (inputs: Public_Nav_Business_LabelInputs) => LocalizedString;
export const public_nav_calendar_description: (inputs: Public_Nav_Calendar_DescriptionInputs) => LocalizedString;
export const public_nav_calendar_label: (inputs: Public_Nav_Calendar_LabelInputs) => LocalizedString;
export const public_nav_callout_cta: (inputs: Public_Nav_Callout_CtaInputs) => LocalizedString;
export const public_nav_callout_description: (inputs: Public_Nav_Callout_DescriptionInputs) => LocalizedString;
export const public_nav_callout_meta: (inputs: Public_Nav_Callout_MetaInputs) => LocalizedString;
export const public_nav_callout_title: (inputs: Public_Nav_Callout_TitleInputs) => LocalizedString;
export const public_nav_community_title: (inputs: Public_Nav_Community_TitleInputs) => LocalizedString;
export const public_nav_contact_label: (inputs: Public_Nav_Contact_LabelInputs) => LocalizedString;
export const public_nav_council_description: (inputs: Public_Nav_Council_DescriptionInputs) => LocalizedString;
export const public_nav_council_label: (inputs: Public_Nav_Council_LabelInputs) => LocalizedString;
export const public_nav_departments_label: (inputs: Public_Nav_Departments_LabelInputs) => LocalizedString;
export const public_nav_government_label: (inputs: Public_Nav_Government_LabelInputs) => LocalizedString;
export const public_nav_home_label: (inputs: Public_Nav_Home_LabelInputs) => LocalizedString;
export const public_nav_legal_accessibility: (inputs: Public_Nav_Legal_AccessibilityInputs) => LocalizedString;
export const public_nav_legal_privacy: (inputs: Public_Nav_Legal_PrivacyInputs) => LocalizedString;
...
export const public_nav_permits_description: (inputs: Public_Nav_Permits_DescriptionInputs) => LocalizedString;
export const public_nav_permits_inspections_label: (inputs: Public_Nav_Permits_Inspections_LabelInputs) => LocalizedString;
export const public_nav_permits_label: (inputs: Public_Nav_Permits_LabelInputs) => LocalizedString;
export const public_nav_public_notices_description: (inputs: Public_Nav_Public_Notices_DescriptionInputs) => LocalizedString;
export const public_nav_public_notices_label: (inputs: Public_Nav_Public_Notices_LabelInputs) => LocalizedString;
export const public_nav_report_issue_label: (inputs: Public_Nav_Report_Issue_LabelInputs) => LocalizedString;
export const public_nav_residents_label: (inputs: Public_Nav_Residents_LabelInputs) => LocalizedString;
export const public_nav_search_label: (inputs: Public_Nav_Search_LabelInputs) => LocalizedString;
export const public_nav_search_placeholder: (inputs: Public_Nav_Search_PlaceholderInputs) => LocalizedString;
export const public_nav_services_title: (inputs: Public_Nav_Services_TitleInputs) => LocalizedString;
export const public_nav_trash_collection_description: (inputs: Public_Nav_Trash_Collection_DescriptionInputs) => LocalizedString;
export const public_nav_trash_collection_label: (inputs: Public_Nav_Trash_Collection_LabelInputs) => LocalizedString;
export const public_nav_water_sewer_description: (inputs: Public_Nav_Water_Sewer_DescriptionInputs) => LocalizedString;
export const public_nav_water_sewer_label: (inputs: Public_Nav_Water_Sewer_LabelInputs) => LocalizedString;
export const public_not_found_body: (inputs: Public_Not_Found_BodyInputs) => LocalizedString;
export const public_not_found_eyebrow: (inputs: Public_Not_Found_EyebrowInputs) => LocalizedString;
...
export const public_shell_footer_copyright_suffix: (inputs: Public_Shell_Footer_Copyright_SuffixInputs) => LocalizedString;
export const public_shell_footer_email_label: (inputs: Public_Shell_Footer_Email_LabelInputs) => LocalizedString;
export const public_shell_footer_hours_label: (inputs: Public_Shell_Footer_Hours_LabelInputs) => LocalizedString;
export const public_shell_footer_navigation_label: (inputs: Public_Shell_Footer_Navigation_LabelInputs) => LocalizedString;
export const public_shell_footer_official_summary: (inputs: Public_Shell_Footer_Official_SummaryInputs) => LocalizedString;
export const public_shell_footer_phone_label: (inputs: Public_Shell_Footer_Phone_LabelInputs) => LocalizedString;
export const public_shell_header_close_navigation: (inputs: Public_Shell_Header_Close_NavigationInputs) => LocalizedString;
export const public_shell_header_main_menu: (inputs: Public_Shell_Header_Main_MenuInputs) => LocalizedString;
export const public_shell_header_mobile_menu: (inputs: Public_Shell_Header_Mobile_MenuInputs) => LocalizedString;
export const public_shell_header_open_navigation: (inputs: Public_Shell_Header_Open_NavigationInputs) => LocalizedString;
export const public_shell_header_utility_navigation: (inputs: Public_Shell_Header_Utility_NavigationInputs) => LocalizedString;
export const public_shell_main_label: (inputs: Public_Shell_Main_LabelInputs) => LocalizedString;
export const public_site_fallback_address: (inputs: Public_Site_Fallback_AddressInputs) => LocalizedString;
export const public_site_fallback_municipality_name: (inputs: Public_Site_Fallback_Municipality_NameInputs) => LocalizedString;
export const public_site_fallback_office_hours: (inputs: Public_Site_Fallback_Office_HoursInputs) => LocalizedString;
export const public_site_fallback_phone: (inputs: Public_Site_Fallback_PhoneInputs) => LocalizedString;
export const public_site_fallback_tagline: (inputs: Public_Site_Fallback_TaglineInputs) => LocalizedString;
